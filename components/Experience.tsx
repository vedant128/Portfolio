...
const experienceData = [
    {
        ...
        description: "Worked as a Web Developer Intern using MERN Stack",
        skills: ["Javascript", "ReactJS", "NodeJS", "ExpressJS", "NextJS", "MongoDB", "Firebase"],
        icon: "🌐",
    },
    {
        ...
        skills: ["Figma", "Canva", "UI/UX", "Branding", "Team Work"],
        icon: "🎨",
    },
    {
        ...
        skills: ["Java", "Android SDK", "REST APIs"],
        icon: "📱",
    },
];
